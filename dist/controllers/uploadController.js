...
const uploadFiles = async (req, res) => {
    try {
        ...
        if (!fs_1.default.existsSync(constants_1.UPLOADS_DIR)) {
            fs_1.default.mkdirSync(constants_1.UPLOADS_DIR, { recursive: true });
            console.log(`Created uploads directory at ${constants_1.UPLOADS_DIR}`);
        }
