...
const downloadExcel = async (req, res) => {
    try {
        const excelPath = path_1.default.join(constants_1.OUTPUTS_DIR, "result.xlsx");
        ...
        res.download(excelPath, fileName, async (err) => {
            ...
            try {
                await file_utils_1.FileUtils.clearDirectory(constants_1.UPLOADS_DIR);
                await file_utils_1.FileUtils.clearDirectory(constants_1.OUTPUTS_DIR);
